...
template<typename SettingT, typename ParamT>
inline void ParametersHandler::getParam(
...
template<typename ParamT, typename SettingT, typename NodeT>
inline void ParametersHandler::setParam(
...
template<typename T>
inline void ParametersHandler::setDynamicParamCallback(T & setting, const std::string & name)
{
...
template<typename T>
inline auto ParametersHandler::as(const rclcpp::Parameter & parameter)
{
